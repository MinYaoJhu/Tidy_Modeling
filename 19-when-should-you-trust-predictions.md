...
<p class="caption">Simulated two-class data set with a logistic regression fit and decision boundary.</p>
</div>
...
<p class="caption">The effect of equivocal zones on model performance</p>
</div>
...
<p class="caption">The effect of the standard error of prediction overlaid with the test set data</p>
</div>
...
<p class="caption">Two weeks of 2016 predictions for the Chicago data along with 95% prediction intervals</p>
</div>
...
<p class="caption">Two weeks of 2020 predictions for the Chicago data along with 95% prediction intervals</p>
</div>
...
<p class="caption">The PCA reference distribution based on the training set</p>
</div>
...
<p class="caption">The reference distribution with two new points: one using the test set and one from the 2020 data</p>
</div>
...
<p class="caption">The results of using the `autoplot()` method on an applicable object</p>
</div>
